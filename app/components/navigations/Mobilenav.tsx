...
const Mobilenav = ({nav,closeNav}:Props) => {
  ...
  return (
    <div className={`transform transition-all ${navOpenStyle} duration-200 fixed top-0 left-0 z-[200] h-[100vh] right-0 bottom-0 bg-[#31d5e0]`}>
      ...
      <ul className=' relative z-[201] space-y-10  flex flex-col justify-center h-[100%]  items-center '>
            ...
            <li className='text-[25px] cursor-pointer text-white hover:text-blue-800 transition-all duration-200 '>
